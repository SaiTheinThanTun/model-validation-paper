...
clinmonth_det<-GMSout0[,2]
clinmonth_tot<-GMSout0[,3]
prevalence<-GMSout0[,4]
...
y2<-clinmonth_tot[runin:length(clinmonth_tot)]
...
maxy<-finprev
plot(times[(runin:length(prevalence))],prevalence[(runin:length(prevalence))], type='l',lty=1,col=rgb(0,0,0,alpha=0.25),xlab = "Time",ylab="% prevalence",main="Predicted true prevalence",ylim=c(0,maxy),lwd=6)
